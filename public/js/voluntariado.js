        ...
        <div class="contenedor__areas__voluntariado">
            <div class="container__area">
                <div>
                    ...
                    <img class="container__area__img" src={{img}} alt={{titulo}}</img>
                </div>
                <div class="container__areaInfo">
                    ...
                    <div class="area__c1">
                        ...
                        <p class="container__area__area areas">Área: {{area}}</p>
                        <p class="container__area__duracion areas">Duración: {{duracion}}</p>
                    </div>
...
function filtrarCatalogoPorCategorias(filtros) {
    let pruebas = [];
    pruebas = filtros.flatMap(element => catalogo.filter(taller => taller.conexion.includes(element)));
